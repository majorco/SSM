...
<div id="menuEditModal" class="modal fade in" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
			...
			<form>
				...
				<div class="modal-footer">
					...
					<button id="menuEditResetBtn" type="reset" class="btn btn-primary"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</div>
			</form>
		</div>
	</div>
